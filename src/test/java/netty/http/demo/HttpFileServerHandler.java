...
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    // private static void setContentlength(HttpResponse response, long
    // fileLength) {
    ...
    private String sanitizeUri(String uri) {
        try {
            ...
            try {
                uri = URLDecoder.decode(uri, "IS0-8859-1");
    ...
    private void sendListsing(ChannelHandlerContext ctx, File dir) {
